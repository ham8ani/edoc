...
<div class="card mt-3">
  <div class="card-header bg-success text-white ">
    Form Data Upload Dokumen
  </div>
  <div class="card-body">
    <form method="post" action="" enctype="multipart/form-data" >
	  <div class="form-group">
	    <label for="no_surat">No Dokumen</label>
	    <input type="text" class="form-control" id="no_surat" name="no_surat" value="<?=@$vno_surat?>">
	  </div>
	  <div class="form-group">
	    <label for="tanggal_surat">Tanggal Dokument</label>
	  ...
	  <div class="form-group">
	    <label for="prihal">Deskripsi</label>
	    <input type="text" class="form-control" id="prihal" name="prihal" value="<?=@$vprihal?>">
	  </div>
	  <div class="form-group">
	    <label for="id_departemen">Divisi/Bagian</label>
	  ...
	  <div class="form-group">
	    <label for="id_pengirim">Jenis Dokumen</label>
